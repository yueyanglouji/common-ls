...
//        final Path path;
//        try {
//            path = VFS.getRoot().get().get(name).mount(RealPathMount.class).getRealPath();
//        } catch (IOException e) {
...
//                        Path p = VFS.getRoot().get().get(entry).mount(RealPathMount.class).getRealPath();
//                        if (p.toFile().exists()) {
//                            uri = p.toFile().getCanonicalFile().toURI();
//                        } else {
//                            p = VFS.getRoot().get().get(path.toString()).get("../" + entry).mount(RealPathMount.class).getRealPath();
//                            if (p.toFile().exists()) {
//                                uri = p.toFile().getCanonicalFile().toURI();
//                            } else {
//                                continue;
...
//                final Path depPath;
//                try {
//                    depPath = path.resolveSibling(VFS.getRoot().get(uri).getPath()).normalize();
//                } catch (IOException e) {
//                    throw new RuntimeException(e);
//                }
